...
import { useTiempoMuertoCorte } from "../hooks/queries/useTiempoMuertoCorte";
 ...
 */
export function TiemposMuertosPlanta3CortePage() {
    ...
    const { data: tiemposMuertos = [], isLoading } = useTiempoMuertoCorte();
            ...
            <main className="flex-1 rounded-2xl border bg-linear-to-b from-muted/50 to-background p-4 dark:from-zinc-950/60 dark:to-zinc-950/20">
                <section className="flex h-full flex-col gap-4">
                    ...
                    <div className="w-full">
                        <HeaderParos
                            title="Tiempos muertos de Corte Planta 3"
                            description="Monitoreo de máquinas de Corte."
